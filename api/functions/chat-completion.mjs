...
function validateRequest(requestData) {
    ...
    if (requestData.maxTokens !== undefined &&
...
async function retryRequest(operation, context, maxRetries = 3, baseDelay = 300) {
    let lastError;
 ...
 */
export async function chatCompletionHandler(request, context) {
